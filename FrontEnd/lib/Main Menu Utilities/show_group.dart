        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            var data = await Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => AddExpense(widget.groupInfo)));
            if (data != null) {
              var input = {
                "expenseName": data[0],
                "expense": data[1],
              };
              widget.groupInfo["expenses"].add(input);
              input["_id"] = widget.groupInfo["_id"];
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Text(
                                      "For ${widget.groupInfo["expenses"][index]["expenseName"]}:",
                                      style: const TextStyle(
                                          color: Colors.black,
                                          fontSize: 28,
                                    ...
                                    GestureDetector(
                                      onTap: () async {
                                        var input = {
                                          "_id": widget.groupInfo["_id"],
                                          "data": widget.groupInfo["expenses"]
                                              [index],
                                        };
                                        widget.groupInfo["expenses"]
                                            .removeAt(index);
                                        await http.delete(
                                ...
                                ListView.builder(
                                    shrinkWrap: true,
                                    itemCount: widget
                                        .groupInfo["expenses"][index]["expense"]
                                        .length,
                                    itemBuilder:
                                        (BuildContext context, int index1) {
                                      if (widget.groupInfo["expenses"][index]
                                              ["expense"][index1] >
                                          0) {
                                        return Text(
              ...
              Padding(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      } else if (widget.groupInfo["toPay"][userIndex][index] <
                          0) {
                        return Card(
                          elevation: 10,
                          color: Colors.white,
                                                ...
                                                GestureDetector(
                                                  onTap: () async {
                                                    if (amountController.text != "") {
                                                      ...
                                                      await http.post(Uri.parse(payMoneyUrl),
                                                          headers: {
                                                            "Content-Type":
                                                                "application/json"
                                                          },
